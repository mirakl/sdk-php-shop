...
use Mirakl\MMP\FrontOperator\Domain\Collection\Promotion\PromotionIdentifierCollection;

/**
 * (PR01) List promotions information
 *
 * @method  PromotionIdentifierCollection   getIds()
 * @method  $this                           setIds(PromotionIdentifierCollection|array $ids)
