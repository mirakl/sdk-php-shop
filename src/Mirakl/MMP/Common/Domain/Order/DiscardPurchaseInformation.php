 ...
 * @method $this                           setPurchaseCommissionOnFees(array|DiscardPurchaseCommissionOnFees $commissionPrice)
 * @method DiscardPurchaseFeeAmount        getPurchaseFeeAmount()
 * @method $this                           setPurchaseFeeAmount(array|DiscardPurchaseFeeAmount $commissionPrice)
